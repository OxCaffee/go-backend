...
|`update ... where pk = ...`|`update t set c4 = 12 where c1 = 20`|在c1=20记录上加X锁，即`LOCK_X|LOCK_REC_NOT_GAP`|主键等值查询并更新，记录存在，且未更新索引列|
|`update ... where pk = ...`|`update t set c2 = 12 where c1 = 20`|在c1=20