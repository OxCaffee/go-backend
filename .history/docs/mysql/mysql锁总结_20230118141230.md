...
|`update ... where pk >= ...`|`update t set c4 = 100 where c1 >= 20`|对c1=20加X锁，即`LOCK_X|LOCK_REC_NOT_GAP`，对c1=30和c1=40和正无穷点supreme加临键锁，即`LOCK_X|LOCK_ORDINARY`，加锁区间为`(20, 30], (30, 40], (40, +∞)`
